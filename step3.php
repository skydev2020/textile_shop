<?php 
 ...
 if(!isset($_SESSION['cart']['product_details']) && $_REQUEST['page_step']!='step3')
 {
 		?>
 ...
 if(!isset($_SESSION['cart']['user_details']))
 {
 	?>
    <script type="text/javascript">
		window.location.href = "https://www.solemlux.lt/eshopdev/<?php echo $producturl;?>/step2";
	</script>
    <?php
	exit;
 }
 ...
 .step3tab
{
	position: absolute;width: 96% !important;background: #808080;padding: 0px 12px;color: #fff;border-radius: 9px 0 0 9px;text-transform: uppercase;line-height: 54px;letter-spacing: 0.6px;margin-left: 23px;margin-bottom: 15px;
}

@media (max-width: 800px){
	.step3tab
{
position: absolute;width: 90% !important;background: #808080;padding: 0px 12px;color: #fff;border-radius: 9px 0 0 9px;text-transform: uppercase;line-height: 46px;letter-spacing: 0.6px;margin-left: 16px;margin-bottom: 15px;
}
}
...
<script type="text/javascript">
 ...
 function edit_order(e, idx, module_name) {
			...
			window.location.href = "https://www.solemlux.lt/eshopdev/<?php echo $producturl;?>/?" + url;
			return false;
                                ...
                                <div class="col-md-12 no-padd inwindow" id="inwindow" style="display:none;">
                                 ...
                                 <div class="table-responsive" id="addPro" style="display:none;" >
                                   <?php 
                                    ...
                                    <table class="table table-bordered"  style=" <?php if(isset($edit_data) && isset($edit_data['additional_choices'])) { echo 'display: table !important;'; }?>">
                                        <?php
                                        if(!isset($edit_data)) {
                                            echo '
                        ...
                        <div class="row">
							...
							<div class="row">
                                <div class="col-md-12 no-padd">
								 ...
								 <tabff></tabff>
                                    <div class="description col-md-12 no-padd" style="font-family: 'PT Sans', sans-serif;font-size: 14px;line-height: 20px;color:#000;text-decoration: none;">
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">Pasirinkite pageidaujamą šio užsakymo pristatymo metodą.
                                            </font>
                                        </font>
                                    </div>
                                    <div class="col-md-12 no-padd" style="margin-top:15px;">
                                        <div class="title" style="font-weight:bold;">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Pristatymas
                                                </font>
                                            </font>
                                        </div>
                                        <div class="ship_method">
                                        <?php $sql = "SELECT * FROM take_away_shipping ";
//echo $sql;exit;

$result=mysqli_query($conn, $sql);?>
      <?php $row = mysqli_fetch_array($result);  ?>
                                            <?php
											$mystrings = $_SESSION['cart']['user_details']['shipping_method'];
										$mystring = $mystrings;
...
//echo $mystring;
//echo $_SESSION['cart']['user_details']['shipping_method'];exit;
											/*if($_SESSION['cart']['user_details']['total_final_amount'] >= $mystrings){
												echo '<input type="radio" name="shipping_method" data-value="0.00" value="Atsiėmimas Kaune (PC Ermitažas Raudondvario pl. 13)" style="margin-top:5px;">&nbsp;';
												
											}else{
                                                if ((isset($mystrings) && $mystrings == $row['delivery_price'])) {
                                                    echo '<input type="radio" name="shipping_method" data-value="'.$row['delivery_price'].'" value="'.$row['delivery_price'].'" style="margin-top:5px;" checked>&nbsp;';
                                                } else if (isset($mystrings) == false) {
                                                    echo '<input type="radio" name="shipping_method" data-value="'.$row["abroad_price"].'" value="'.$row["abroad_price"].'" style="margin-top:5px;" checked>&nbsp;';
                                                } else {
                                                    echo '<input type="radio" name="shipping_method" data-value="1000.00" value="Atsiėmimas Kaune (PC Ermitažas Raudondvario pl. 13)" style="margin-top:5px;">&nbsp;';
                                                }
											}*/
                                            ?>
                                            
                                            <span style="display:none;"><input type="radio" name="shipping_method" value="no" style="margin-top:5px;" style="">&nbsp;</span>
                                            <!--<font class="pay" style="vertical-align: inherit;">Atsiėmimas Kaune (PC Ermitažas Raudondvario pl. 13)
                                            </font>
...
$result=mysqli_query($conn, $sql);?>
      <?php while($row = mysqli_fetch_array($result)) {  ?>
                                        <div class="ship_method">
                                            <input type="radio" name="shipping_method" data-name="<?php echo $row["d_name"]; ?>" data-value="<?php if($propricesum < $row["abroad_free_delivey"]) {  echo number_format((float)$row["abroad_price"], 2, '.', ''); }else{ echo "0.00";  }?>" value="<?php echo $row["id"]; ?>" style="margin-top:5px;" <?php if($mystring ==  $row["id"]){?>checked="checked"<?php } ?>>&nbsp;
                             ...
                             <div class="row">   
                                <div class="col-md-12 no-padd">
								 ...
								 <tabff></tabff>                   
                                    <div class="description col-md-12" style="font-family: 'PT Sans', sans-serif;font-size: 14px;line-height: 20px;color:#000;text-decoration: none;">
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">Pasirinkite pageidaujamą šio užsakymo mokėjimo būdą.
                                            </font>
                                        </font>
                                    </div>
                                    <div class="col-md-12 no-padd" style="margin-top:10px;">
                                        <!--div class="ship_method">
                                          ...
                                          <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Mokėjimas per Paysera
                                                </font>
                                            </font>
                                        </div-->
                                        <div class="ship_method">
                                            <?php
                                                if ((isset($_GET['paymentmethod']) && $_GET['paymentmethod'] == 'Mokėjimas pavedimu')) {
                                                    echo '<input type="radio" data-value="0" name="payment_method" value="Mokėjimas pavedimu" style="margin-top:5px; " checked>&nbsp;';
                                                } else if (isset($_GET['paymentmethod']) == false) {
                                                    echo '<input type="radio" data-value="0" name="payment_method" value="Mokėjimas pavedimu" style="margin-top:5px; " checked>&nbsp;';
                                                } else {
                                                    echo '<input type="radio" data-value="0" name="payment_method" value="Mokėjimas pavedimu" style="margin-top:5px; ">&nbsp;';
                                                }
                                            ?>
                                            <span style="display:none;"><input type="radio" name="payment_method" value="no" style="margin-top:5px; " >&nbsp;</span>
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Mokėjimas pavedimu
                                                </font>
                                            </font>
                                        </div>
                                        <div class="ship_method">
                               <input type="radio" data-value="2" name="payment_method" value="Mokėjimas kurjeriui 2 eur" style="margin-top:5px;" <?php if($_SESSION['cart']['user_details']['payment_method'] == 'Mokėjimas kurjeriui 2 eur'){ echo  'checked';} else { echo '';}?>>&nbsp;
                                            <span style="display:none;"><input type="radio" name="payment_method" value="no" style="margin-top:5px; " >&nbsp;</span>
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Mokėjimas kurjeriui 2 eur
                                                </font>
                                            </font>
                                        </div>
                                        <div class="ship_method">
                                            <input type="radio" data-value="0" name="payment_method" value="Mokėjimas grynais salonuose" style="margin-top:5px; " <?php 
											if($_SESSION['cart']['user_details']['payment_method'] == 'Mokėjimas grynais salonuose'){ echo  'checked';} else { echo '';}?>>&nbsp;
                                            
                                            <span style="display:none;"><input type="radio" name="payment_method" value="no" style="margin-top:5px; " >&nbsp;</span>
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Mokėjimas grynais salonuose
                                                </font>
                                            </font>
                                        </div>
                                        
                                        <div class="ship_method">
                                            <input type="radio" data-value="0" name="payment_method" value="Paysera" style="margin-top:5px;" <?php 
											if($_SESSION['cart']['user_details']['payment_method'] == 'Paysera'){ echo  'checked';} else { echo '';}?>>&nbsp;
                                            <span style="display:none;"><input type="radio" name="payment_method" value="no" style="margin-top:5px; " >&nbsp;</span>
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Paysera
                                                </font>
                                            </font>
                                        </div>
...
?> 
    ...
    <div class="row setup-content" id="step-3">
        <form id="myform3" method="post" action="https://www.solemlux.lt/eshopdev/order_sub.php">
            <div class="col-xs-12" id="amardivrelocheckkorlo">
                ...
                <div class="clearfix well">
                    <div class="row">
                    <h4 class="list-group-item-heading ar-main-heading step3tab">Užsakymo patvirtinimas</h4>
                    <?php
                    ...
                    foreach ($cart_details as $key) {
                        ...
                        <?php 
						 ...
						 $aaa = getdataB('<td id="display_kaina_tr" class="display_kaina_tr" style="color: #4a4545;font-weight: bold;">','</td>',$key['table']);
						  
						  $vvv =  strip_tags(trim(str_replace('€','', $aaa)));
						 
						 $array[$i-1] = $vvv;
						  

						 $sum_price = $sum_price +  $vvv;
                         
						
						++$i;
                    }

                    $total_price_get =  $sum_price;

                       // SHIPPING PRICE - $pristatymo_kaina_selected ;
                    $mystringss = $_SESSION['cart']['user_details']['shipping_method'];
                            
                    $sqll = "SELECT * FROM take_away_shipping where id = '".$mystringss."'";
                    
                    $resultt=mysqli_query($conn, $sqll);
                    $roww = mysqli_fetch_array($resultt);

                    if ($_SESSION['cart']['user_details']['country']="Lietuva")
                    {
                        if ($total_price_get >= $roww["d_free_delivery_from"])
                        { $pristatymo_kaina_selected = 0;}
                    else {
                            $pristatymo_kaina_selected = $roww["d_price"];
                         }
                        
                    }
                    else
                    {
                        if ($total_price_get >= $roww["abroad_free_delivey"])
                        { $pristatymo_kaina_selected = 0;}
                    else  {
                            $pristatymo_kaina_selected = $roww["abroad_price"];
                            }
                    }
                        
                    if($_SESSION['cart']['user_details']['payment_method']=="Mokėti kurjeriui grynaisiais")
                    {
                        $pristatymo_kaina_selected = $pristatymo_kaina_selected + 2;
                    }
                    // SHIPPING PRICE - $pristatymo_kaina_selected ;

                    $voucher_price = 0;
                    // get voucher details
                    $voucher_code = $_SESSION['cart']['user_details']['voucher_code'];

                    $voucher_result = mysqli_query($conn, "SELECT * FROM coupons where codename='$voucher_code' and status=1 and available>0 and from_date <= CURDATE()  AND TO_DATE >= CURDATE() limit 1"); 
                    
                    // var_dump("SELECT * FROM coupons where codename='$voucher_code' and status=1 and available>0 and cart_amount < $sum_price and from_date <= CURDATE()  AND TO_DATE >= CURDATE() limit 1");

                    $voucher = null;

                    if ($voucher_result->num_rows > 0) {
                        
                        // calculate the total price first and check whether to apply voucher or not
                       
                        $voucher = mysqli_fetch_object($voucher_result);
                        $can_fixed_voucher = false; // used for fixed amount voucher apply?

                        if ($voucher->type==0) {
                            $voucher_price = 0;
                            if ($voucher-> cart_amount < $total_price_get) {

                                // apply the percentage voucher logic
                                foreach ($cart_details as $key) {
                                    // apply voucher in case only percentage
                                    $product_id = getProductId($key['imgsrc']);                           
                                    $aaa = getdataB('<td id="display_kaina_tr" class="display_kaina_tr" style="color: #4a4545;font-weight: bold;">','</td>',$key['table']);
                                  
                                    $vvv =  strip_tags(trim(str_replace('€','', $aaa)));

                                    // check whether to apply on discounted products
                                    if ( $voucher->discounted_products == 0 || ($voucher->discounted_products == 1 && $key['discount_value'] ==0)) {
                                        if (strpos($voucher->limit_products, (string)$product_id) !== false) {
                                            $voucher_price = $voucher_price +  $vvv * (100-$voucher->amount) / 100;;
                                        }
                                        else {
                                            $voucher_price = $voucher_price +  $vvv;
                                        }    
                                    }
                                    else {
                                        $voucher_price = $voucher_price +  $vvv;              
                        ...
                        if ($voucher->type == 1) {
                            ...
                            // check fixed amount voucher
                            foreach ($cart_details as $key) {
                                // check whether cart items contain proper voucher-specified product and discount opption
                                $product_id = getProductId($key['imgsrc']);                                                        
                                // check at least one cart item belongs to voucher along with discounted product option
                                if ( $voucher->discounted_products == 0 || ($voucher->discounted_products == 1 && $key['discount_value'] ==0)) {
                                    if (strpos($voucher->limit_products, (string)$product_id) !== false) {
                                        $can_fixed_voucher=true;
                                        break;
                                    }    
                                }
                            }

                            $voucher_price=$total_price_get;

                            // apply fixed amount voucher if total deduction    
                            // checking when to apply according to the shipping checkbox
                            if ($can_fixed_voucher==true) {
                                if (($voucher->shipping ==1) && ($voucher->cart_amount < $sum_price)) {
                                    $voucher_price = $total_price_get-$voucher->amount;
                                }
                                else if (($voucher->shipping ==0) && ($voucher->cart_amount < $sum_price + $pristatymo_kaina_selected)) {
                                    $voucher_price = $total_price_get-$voucher->amount;
                                }    
                            }
                        ...
                        $voucher_price=$total_price_get;
                        unset($_SESSION['cart']['user_details']['voucher_code']);
                        unset($_SESSION['cart']['user_details']['voucher_name']);
                        $voucher_code = null;
                    }
                    					
			        $total_price_get = $total_price_get + $pristatymo_kaina_selected;
					
					?>
                            <div class="total_summary_seaction cart_uu" id="getsummary">
                                <div class="no-padd-side col-md-6 col-md-offset-3" style="padding:15px 0px;">
                                    <table class="table table-bordered table_fixed">
                                        ...
                                        <span id="total_sum"><?php echo number_format((float)$sum_price, 2, '.', '');?> €</span>
                                        </td>
                                        </tr>
										<? 
									    $_diff=$sum_price-$voucher_price;
                                        $voucher_visible = ($voucher_code ? "display: table-row;" : "display: none;"); 
										?>
    									<tr style="<?php echo $voucher_visible; ?>">
                                            <th>Panaudotas nuolaidos kuponas ir nuolaida:</th>
                                            <td style="width: 250px">
                                                <span>
                                                    <?php echo $voucher_code; ?> (<?php echo number_format((float)($sum_price-$voucher_price), 2, '.', '');?> €)
                                                </span>
                                            </td>
                                        </tr>
                                        ...
                                        <td style="width: 250px">
                                            <span id="pristatymo_kaina_selected">
                                                <?php echo number_format((float)$pristatymo_kaina_selected, 2, '.', '');?> €
                                            </span>                                            
                                        </td>
                                        </tr>
                                        <tr>
                                        <th>Viso su PVM:</th>
                                        <td style="width: 250px">
                                        <span id="visu_so_pvm"><?php echo $total_final_amount =  number_format((float)$voucher_price + $pristatymo_kaina_selected , 2, '.', '');?> €</span>
                                        </td>
                                        </tr>
                                        </table>
                                        <?php
											$_SESSION['total_final_amount'] = $total_final_amount;
										?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 clearfix cart_uu" id="cart_user">
                                ...
                                <div class="no-padd-side" style="padding:15px 0px;">
                                    <table class="table table-bordered table_fixed">
                                        ...
                                        <span>
                                        <?php 
                                            $idss = $_SESSION['cart']['user_details']['shipping_method'];
										    $sql = "SELECT * FROM take_away_shipping where id = '".$idss."'";
//echo $sql;exit;
                                            $result=mysqli_query($conn, $sql);
                                            $row = mysqli_fetch_array($result);
                                            echo $row['d_name'];
                                            echo $row['s_name'];
                                            // var_dump($_SESSION['cart']['user_details']['payment_method']);
                                            // var_dump($_SESSION['cart']['user_details']['shipping_method']);
