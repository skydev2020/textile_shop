...
jQuery(document).ready(function(){
	setTimeout(function(){$(".responsive-menu").click();}, 200);
...
/*@media (max-width: 769px){
    .disnone {
      ...
      <div class="middimg top_margin_class ar-page-top">
           <a href="https://www.solemlux.lt/eshopdev/roletai-plastikiniams-langams/"> <img src="https://www.solemlux.lt/eshopdev/mainimage.png" class="full" width="85%"></a>
	  </div>
